...
def chat_with_openai_rf(image_paths, gif_paths, text_prompts):
    ...
    # base64_image7 = encode_image("/root/abhranil/AVDC/flowdiffusion/feedback_fewshot/assembly.png")
    # base64_image7_out = encode_gif("/root/abhranil/AVDC/flowdiffusion/feedback_fewshot/assembly_out_1iter_1.gif")
    # base64_image6_out = encode_gif("/root/abhranil/AVDC/flowdiffusion/feedback_fewshot/basketball_out_1iter_00.gif")
    # base64_image6 = base64_image6_out[0]
    # base64_image5_out = encode_gif("/root/abhranil/AVDC/flowdiffusion/feedback_fewshot/hammer_checkpoint_310_out_0iter_7.gif")
...
if __name__ == "__main__":
    ...
    #with open("feedback_binary_mw.json", "w") as final:
