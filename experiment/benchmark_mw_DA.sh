...
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch benchmark_mw.py --env_name $task --n_exps 25 --ckpt_dir "../ckpts/metaworld_DA" --milestone 305 --result_root "../results/results_VideoAgent_mw_DA"
done

python org_results_mw.py --results_root "../results/results_VideoAgent_mw_DA"
